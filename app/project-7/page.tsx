...
export default function Project7Page() {
  const vimeoSrc =
    "https://player.vimeo.com/video/1156461800?badge=0&autopause=0&player_id=0&app_id=58479";
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
        ...
        >
          RNBOI FT. NONO LA GRINTA — AVEC MOI
        </h1>
      </div>
      ...
      >
        ...
        >
          <iframe
            ...
            allowFullScreen
            title="RNBOI FT. NONO LA GRINTA — AVEC MOI"
          />
        </div>
      </div>
    </main>
